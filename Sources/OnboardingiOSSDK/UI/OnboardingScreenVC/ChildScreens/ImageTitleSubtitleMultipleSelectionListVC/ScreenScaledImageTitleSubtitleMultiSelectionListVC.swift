...
class ScreenScaledImageTitleSubtitleMultiSelectionListVC: BaseChildScreenGraphViewController {
    ...
    var screenData: ScreenScalableImageTextSelection!

    var selectedItem = [Int]()
    
    let cellConfigurator = ImageLabelCheckboxMultipleSelectionCollectionCellNoBorderConfigurator.init()
    
    static func instantiate(screenData: ScreenScalableImageTextSelection) -> ScreenScaledImageTitleSubtitleMultiSelectionListVC {
        let imageTitleSubtitleMultipleSelectionListVC = ScreenScaledImageTitleSubtitleMultiSelectionListVC.storyBoardInstance()
...
extension ScreenScaledImageTitleSubtitleMultiSelectionListVC: UICollectionViewDataSource {
...
extension ScreenScaledImageTitleSubtitleMultiSelectionListVC: UICollectionViewDelegate {
...
extension ScreenScaledImageTitleSubtitleMultiSelectionListVC: UICollectionViewDelegateFlowLayout {
...
private extension ScreenScaledImageTitleSubtitleMultiSelectionListVC {
...
// MARK: - Open methods
extension ScreenScaledImageTitleSubtitleMultiSelectionListVC {
